...
#import "GIKImageFilesViewController.h"
#import "GIKImageFilesPopoverBackgroundView.h"

@interface GIKImageFilesViewController () {
...
@implementation GIKImageFilesViewController
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    if ([segue isKindOfClass:[UIStoryboardPopoverSegue class]])
    {
        ...
        popoverController.popoverBackgroundViewClass = [GIKImageFilesPopoverBackgroundView class];
